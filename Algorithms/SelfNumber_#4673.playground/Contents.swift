...
func getSelfNumberBelow10000() {
    ...
    for number in 1...100 {
        ...
        while mutableNumber > 0 {
            numbers.insert(mutableNumber%10, at: 0)
    ...
    for number in 1...100 {
        comparableNumbers.append(number)
    }

    let selfNumbers:[Int] = comparableNumbers.filter { (number) -> Bool in
